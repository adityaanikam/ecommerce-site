                ...
                <div className="space-y-4">
                  <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    ...
                    <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                      <li>• Category selection now shows as active filter chip</li>
                      <li>• Blue dot is properly centered in radio buttons</li>
                      <li>• All radio buttons use consistent custom styling</li>
                      <li>• Perfect dark theme support</li>
                    </ul>
                  </div>
